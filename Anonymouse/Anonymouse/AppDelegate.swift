...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        DispatchQueue.global(qos: DispatchQoS.QoSClass.utility).async {
            ...
            while !application.backgroundTimeRemaining.isLess(than: 130.0) {
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "io.github.qinyeli.Anonymouse" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Anonymouse", withExtension: "momd")!
