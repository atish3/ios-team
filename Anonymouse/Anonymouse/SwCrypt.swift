...
open class CC {
	...
	open static func crypt(_ opMode: OpMode, blockMode: BlockMode,
        ...
        status = result1.withUnsafeMutableBytes({ (resultBytes: UnsafeMutablePointer<UInt8>) -> CCCryptorStatus in
	...
	open class RSA {
		...
		fileprivate static func xorData(_ data1: Data, _ data2: Data) -> Data {
            ...
            var ret1 = ret
            ret1.withUnsafeMutableBytes { (r: UnsafeMutablePointer<UInt8>) -> Void in
	...
	open class KeyDerivation {
		...
		open static func PBKDF2(_ password: String, salt: Data,
            ...
            let status = result1.withUnsafeMutableBytes {
