...
class AnonymouseTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let topColor = #colorLiteral(red: 0.9490196078, green: 0.4171278212, blue: 0.3137254902, alpha: 1)
        let bottomColor = #colorLiteral(red: 1, green: 0.5490196078, blue: 0.431372549, alpha: 1)
